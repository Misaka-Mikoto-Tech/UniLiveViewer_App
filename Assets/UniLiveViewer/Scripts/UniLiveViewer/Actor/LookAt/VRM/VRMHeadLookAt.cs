...
{
    public class VRMHeadLookAt : IHeadLookAt
    {
        /// <summary>
        ...
        public void Setup(Transform lookTarget, VRMLookAtHead vrmLookAtHead)
        {
            _lookTarget = lookTarget;
            vrmLookAtHead.Target = lookTarget;
